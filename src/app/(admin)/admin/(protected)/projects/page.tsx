...
import { Plus, Pencil, Eye, FolderKanban } from 'lucide-react';
                  ...
                  <tr key={p.id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-5 py-4">
                      <div className="flex items-center gap-2">
                        ...
                        <Link href={`/admin/projects/${p.id}/edit`} className="p-2 text-gray-400 hover:text-secondary-600 rounded-lg hover:bg-secondary-50 transition-colors">
                          <Pencil size={16} />
                        </Link>
                        <DeleteButton id={p.id} apiPath="/api/admin/projects" itemName="project" />
                      </div>
                    </td>
                  </tr>
                ))}
