      ...
      <section className="py-16" style={{ background: "var(--color-warm-white)" }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-3 gap-10">
          ...
          <div className="space-y-6">
            {/* Quick contact */}
            <div className="glass-card p-6">
              <h3 className="font-bold text-primary-800 text-lg mb-4" style={{ fontFamily: "var(--font-serif)" }}>Enquire About This Property</h3>
              <div className="space-y-3 mb-5">
                <a href="tel:0711400933" className="flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium text-primary-700 hover:bg-primary-50 transition-colors">
                  <Phone size={16} className="text-secondary-500" /> 0711 400 933
                </a>
                <a
                  href={getWhatsAppUrl("0711400933", `Hello! I am interested in this property: ${property.name}. Please share more details.`)}
              ...
              <div className="border-t border-gray-100 pt-5">
                <p className="text-xs text-gray-400 mb-4">Or send us a message:</p>
                <ContactForm
